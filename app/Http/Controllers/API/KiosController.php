...
class KiosController extends Controller
{
    public function all(Request $request){
        ...
        if($id){
            ...
            if($kios)
                return ResponseFormatter::success($kios, 'You have successfully getting kios data');
            else
                return ResponseFormatter::error('No data available in kios', 'kios data not found', 404);
        }
    }
}
