                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('master-plts.create') }}" class="btn btn-primary text-right"
                                style="border-radius: 10px;"><i class="fa-solid fa-square-plus mr-2"></i> Data PLTS</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($dataPlts as $plts)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('master-plts.edit', $plts->id) }}"
