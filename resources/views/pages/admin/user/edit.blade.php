                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" name="nama_lengkap"
                                                ...
                                                id="nama_lengkap" value="{{ old('nama_lengkap', $user->nama_lengkap) }}">
                                            @error('nama_lengkap')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <select name="jenis_kelamin" id="jenis_kelamin"
                                                ...
                                                <option value="{{ $user->jenis_kelamin }}" hidden selected>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" name="username"
                                                ...
                                                autofocus value="{{ old('username', $user->login->username) }}">
                                            @error('username')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="email" name="email"
                                                ...
                                                value="{{ old('email', $user->Login->email) }}">
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
