                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" name="username"
                                                ...
                                                autofocus value="{{ old('username', $petugas->login->username) }}">
                                            @error('username')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="email" name="email"
                                                ...
                                                value="{{ old('email', $petugas->Login->email) }}">
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <select name="jenis_kelamin" id="jenis_kelamin"
                                                ...
                                                <option value="{{ $petugas->jenis_kelamin }}" hidden selected>
                                                    {{ $petugas->jenis_kelamin }}</option>
