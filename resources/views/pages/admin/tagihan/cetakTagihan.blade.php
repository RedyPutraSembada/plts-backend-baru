...
<body>
    <header>
        <table align="center">
            <tr>
                <td style="padding-right:20px;"><img src="{{ public_path('logos/logo-sasmita.png') }}" alt="sasmita" width="80px;" height="80px;"></td>
                ...
                <td style="padding-left:20px;"><img src="{{ public_path('logos/logo-unpam.png') }}" alt="unpam" width="80px;" height="80px;"></td>
            </tr>
        </table>
    </header>
