                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" name="username"
                                                ...
                                                autofocus value="{{ old('username', $admin->login->username) }}">
                                            @error('username')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="email" name="email"
                                                ...
                                                value="{{ old('email', $admin->Login->email) }}">
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <select name="jenis_kelamin" id="jenis_kelamin"
                                                ...
                                                <option value="{{ $admin->jenis_kelamin }}" hidden selected>
                                                    {{ $admin->jenis_kelamin }}</option>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <textarea name="alamat" id="alamat" cols="30" rows="10"
                                                class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $admin->alamat) }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
